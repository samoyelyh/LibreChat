...
const databaseName = process.env.RESUME_MCP_DB || 'resume_mcp_gateway';
const username = process.env.RESUME_MCP_DB_USERNAME;
const password = process.env.RESUME_MCP_DB_PASSWORD;
if (!username || !password) throw new Error('Resume gateway MongoDB credentials are required');
